...
def main():
    ...
    # Unlike the buffer memories, this one returns a SINGLE SystemMessage holding
    # an LLM-written summary - not the original turns. See the note in
    # conversation_buffer_memory.py for why {} is required.
